...
Here is a program that lets you prove that you know two small numbers that multiply to 91 without revealing what those numbers are:
...
```
assert verifier.verify_proof(setup, 16, vk, proof, public, optimized=True)
```
