...
%Which leads to, $\mathbf{C} = \mathbf{N} \cup \mathbf{J} \cup \mathbf{F}$.

Which leads to unsurprisingly, $\mathbf{F} \subseteq \mathbf{J} \subseteq \mathbf{C} \subset \mathbf{B}$.



Validators can broadcast two types of messages: $\langle \msgPREPARE, \hash, \epoch, \hashsource, \epochsource \rangle$ and $\langle \msgCOMMIT, \hash, \epoch \rangle$, as seen in \figref{fig:messages}.
...
%    \includegraphics[width=5in]{cs.pdf}
